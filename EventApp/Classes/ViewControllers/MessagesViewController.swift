...
class MessagesViewController: UIViewController {
    ...
    var messages = [MessagesModel(itemsInside: [.mainMessageCell]), MessagesModel(itemsInside: [.messageInfoCell(AlertMessagesModel(image: "messageImage", label: false, text: "This is a very important message! Read it now!", data: "2 min ago"))]),MessagesModel(itemsInside: [.messageInfoCell(AlertMessagesModel(image: "messageImage", label: true, text: "Lorem ipsum dolor sit amet,consectetur adipiscing elit.", data: "1 day ago"))]), MessagesModel(itemsInside: [.messageInfoCell(AlertMessagesModel(image: "messageImage", label: false, text: "his is a very important message! Read it now!", data: "1 day ago"))]), MessagesModel(itemsInside: [.messageInfoCell(AlertMessagesModel(image: "messageImage", label: true, text: "Lorem ipsum dolor sit amet,consectetur adipiscing elit.", data: "2 day ago"))])]
